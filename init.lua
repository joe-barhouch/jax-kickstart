...
-- Make line numbers deffalseault
vim.opt.number = true
...
-- Quick escape
vim.keymap.set('i', 'jk', '<Esc>', { desc = 'Quick [E]scape' })
vim.keymap.set('i', 'jj', '<Esc>', { desc = 'Quick [E]scape' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        -- { "<leader>c_", hidden = true }, -- Optional: uncomment if you need hidden placeholders
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('v', 'v', ':normal! ggVG<CR>', { desc = 'Select all' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters = {
        ruff_fix = {
          prepend_args = { '--ignore=F401,F841,T201' },
        },
      },
    },
  },
